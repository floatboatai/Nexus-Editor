...
- OpenSpec 1.5 uses agent skills instead of `openspec/AGENTS.md`; use the repo-local `.codex/skills/openspec-*` workflows and `openspec/config.yaml` as the source of truth for spec-driven changes.
