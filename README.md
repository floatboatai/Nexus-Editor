...
<details>
<summary><b>Full package list (12 packages)</b> — click to expand</summary>
...
| `@floatboat/nexus-plugin-paste` | HTML / rich-text paste → Markdown (sanitized, syntactically-safe destinations; `data:` images via `ctx.uploadAsset`) |
