...
| 17 | Fuzzy search | `plugin-search` | P2 | in-progress | No | In-house fzf-like backtracking subsequence matcher; `findSearchMatches({ fuzzy: true })` + CM panel / electron-demo toggle |
