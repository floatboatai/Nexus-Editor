...
| # | 功能 | 归属包 | 优先级 | 状态 | 需要 OpenSpec | 备注 |
|---|---|---|---|---|---|---|
| 9  | Widget API 标准化 | `core` | P1 | in-progress | 是 | 走 spec-driven 流程：[`openspec/changes/standardize-widget-api`](../openspec/changes/standardize-widget-api/)；现有 widget 已多次踩坑（见 [`CLAUDE.md`](../CLAUDE.md)） |
